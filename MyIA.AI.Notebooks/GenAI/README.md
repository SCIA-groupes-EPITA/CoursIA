...
<!-- CATALOG-STATUS
series: GenAI
pedagogical_count: 128
breakdown: Audio=30, SemanticKernel=20, Image=17, Texte=17, Video=17, 00-GenAI-Environment=6, PostTraining=6, FineTuning=5, Vibe-Coding=5, CaseStudies=4, root=1
maturity: PRODUCTION=87, BETA=31, ALPHA=5, TEMPLATE=3, DRAFT=2
-->
